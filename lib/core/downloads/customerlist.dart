...
import 'package:newapp/Downloads/storagepermission.dart';
...
var sty1=pw.TextStyle(fontWeight: pw.FontWeight.bold,fontSize: 16,color: PdfColors.grey);
...
customerListWriteOnPdf() async {
  ...
  pdf.addPage(pw.MultiPage(
      ...
      build: (pw.Context context) {
        return <pw.Widget>[
          ...
          pw.Container(
              child: pw.Row(
                 mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                  children: [
                    pw.Text("myCustomer",style: pw.TextStyle(fontWeight: pw.FontWeight.bold,fontSize: 18)),
                    pw.Column(
                    mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                        children:[
          ...
          pw.Container(
            child: pw.Column(
              ...
              children:[
                pw.Row(children:[
                  pw.Text("Transactions Report ( 10/06/20 - 17/06/20 )",
                ...
                pw.Row(
                  ...
                  children: [
                    ...
                    pw.Column(
                      ...
                      children:[
                        pw.Text("Report Generated at:",style: pw.TextStyle(fontSize: 14),),
                        pw.SizedBox(height: 5,),
                        pw.Text("Transaction ID:",style: pw.TextStyle(fontSize: 14),),
                        pw.SizedBox(height: 5,),
                        pw.Text("Number of Customers :",style: pw.TextStyle(fontSize: 14),),
                        pw.SizedBox(height: 5,),
                        pw.Text("Total Recieved:",style: pw.TextStyle(fontSize: 14),),
                        pw.SizedBox(height: 5,),
                        pw.Text("Total Gained:",style: pw.TextStyle(fontSize: 14),),
                        pw.SizedBox(height: 5,),
                      ]
                    ),
                    pw.Column(
                        ...
                        children:[
                          ...
                          pw.Text("$number"),
                          pw.SizedBox(height: 5,),
                          pw.Text("$credit",style: pw.TextStyle(color: PdfColors.green)),
                          pw.SizedBox(height: 5,),
                          pw.Text("$debit",style: pw.TextStyle(color: PdfColors.red)),
                          pw.SizedBox(height: 5,),] )
                  ]
                ),
        ...
        pw.Row(children:[
                pw.Text("Customer : Seyi Onifade",style: pw.TextStyle(fontWeight: pw.FontWeight.bold,fontSize: 18)),])
