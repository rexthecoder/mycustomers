  ...
  void updateAmount(String value, bool update, String action, bool newCus) {
    _debouncer.run(() {
      if (value.length != 0) {
        ...
        if (isNumeric(val) && int.parse(value) != 0) {
          _error = null;
          _amount = double.parse(val);
          show = true;
          update
              ? amount != null && amount != 0 && newODate != null ? save = true : save = false
              : newCus
                  ? action == 'debit'
                      ? amount != null && amount != 0 &&
                              newDate != null &&
                      ...
                      : amount != null && amount != 0 &&
                          ...
                          : save = false
                  : action == 'debit'
                      ? amount != null && amount != 0 && newDate != null
                          ? save = true
                          : save = false
                      : amount != null && amount != 0 && newODate != null
                          ? save = true
                          : save = false;
          notifyListeners();
        } else {
  ...
  void updateNumber(String action) {
    action == 'debit'
        ? amount != null && amount != 0 &&
            ...
            ? save = true
            : save = false
        : amount != null && amount != 0 && newODate != null && name != null && number != null
            ? save = true
            : save = false;
    notifyListeners();
  }
