            ...
            child: ListTile(
              leading: Container(
                ...
                padding: EdgeInsets.all(
                  (model.getProfile()?.image?.length ?? 0) > 0 ? 0 : SizeConfig.yMargin(context, 0.7),
                ),
                ...
                child: (model.getProfile()?.image?.length ?? 0) > 0 ? model.imageFromBaseString(model.getProfile().image, context) : Center(
                  child: Text(
